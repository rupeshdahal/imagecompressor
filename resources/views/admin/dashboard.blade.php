        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <nav class="flex-1 p-4 space-y-1">
                ...
                <a href="{{ route('admin.blog.index') }}"
                   class="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors font-medium text-sm">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6.253v11.494m-5.747-8.622h11.494M4.747 5.126h14.506A1.747 1.747 0 0121 6.873v10.254a1.747 1.747 0 01-1.747 1.747H4.747A1.747 1.747 0 013 17.127V6.873a1.747 1.747 0 011.747-1.747z"/></svg>
                    Blog Manager
                </a>
            ...
            <main class="flex-1 p-4 lg:p-8">
                <div class="animate-slide-up">
                    ...
                    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
                        ...
                        <a href="{{ url('/blog-admin') }}" target="_blank" class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 hover:shadow-lg hover:border-amber-300 dark:hover:border-amber-700 transition-all group">
                            <div class="flex items-center gap-4">
                                <div class="w-12 h-12 bg-amber-100 dark:bg-amber-900/30 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
                                    <svg class="w-6 h-6 text-amber-600 dark:text-amber-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16l5-3 5 3 5-3z"/></svg>
                                </div>
                                <div>
                                    <p class="font-bold text-gray-900 dark:text-gray-100">Open Filament Blog Panel</p>
                                    <p class="text-sm text-gray-500 dark:text-gray-400">Dedicated blog editor in Filament</p>
                                </div>
                            </div>
                        </a>
                        ...
                        <a href="{{ route('admin.blog.index') }}" class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 hover:shadow-lg hover:border-purple-300 dark:hover:border-purple-700 transition-all group">
                            <div class="flex items-center gap-4">
                                <div class="w-12 h-12 bg-purple-100 dark:bg-purple-900/30 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
                                    <svg class="w-6 h-6 text-purple-600 dark:text-purple-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M7 8h10M7 12h10m-7 4h7M5 4h14a2 2 0 012 2v12a2 2 0 01-2 2H5a2 2 0 01-2-2V6a2 2 0 012-2z"/></svg>
                                </div>
                                <div>
                                    <p class="font-bold text-gray-900 dark:text-gray-100">Manage Blog</p>
                                    <p class="text-sm text-gray-500 dark:text-gray-400">Create and edit articles</p>
                                </div>
                            </div>
                        </a>
                    </div>
