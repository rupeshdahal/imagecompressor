...
<head>
    ...
    <title>@yield('title', 'Admin') - CompresslyPro</title>
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <nav class="flex-1 p-4 space-y-1">
                <a href="{{ route('admin.dashboard') }}"
                   class="flex items-center gap-3 px-4 py-3 rounded-xl {{ $__env->yieldContent('nav_dashboard', 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800') }} transition-colors font-medium text-sm">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                    Dashboard
                </a>
                <a href="{{ route('reports') }}"
                   class="flex items-center gap-3 px-4 py-3 rounded-xl {{ $__env->yieldContent('nav_reports', 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800') }} transition-colors font-medium text-sm">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
                    Reports
                </a>
                <a href="{{ route('admin.blog.index') }}"
                   class="flex items-center gap-3 px-4 py-3 rounded-xl {{ $__env->yieldContent('nav_blog', 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800') }} transition-colors font-medium text-sm">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6.253v13m0-13C10.832 5.483 9.246 5 7.5 5 4.462 5 2 6.462 2 9.5V19c0-3.038 2.462-4.5 5.5-4.5 1.746 0 3.332.483 4.5 1.253m0-9.5C13.168 5.483 14.754 5 16.5 5 19.538 5 22 6.462 22 9.5V19c0-3.038-2.462-4.5-5.5-4.5-1.746 0-3.332.483-4.5 1.253"/></svg>
                    Blog Posts
                </a>
        ...
        <div class="flex-1 flex flex-col min-w-0">
            <header class="h-16 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between px-4 lg:px-8 sticky top-0 z-30">
                <div class="flex items-center gap-4">
                    ...
                    <h1 class="text-xl font-bold text-gray-900 dark:text-gray-100">@yield('page_title', 'Admin')</h1>
                </div>
