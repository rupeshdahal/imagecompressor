...
@section('title', 'Free Online Image Compressor - Compress JPG, PNG & WebP Images | Reduce File Size up to 90%')
@section('description', 'Compress images online for FREE! Reduce JPG, PNG, WebP file sizes by up to 90% without quality loss. Fast, secure, no signup.')
@section('keywords', 'image compressor, compress image online, reduce image size, JPG compressor, PNG compressor, WEBP compressor, free image optimizer')
