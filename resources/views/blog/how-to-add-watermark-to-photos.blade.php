...
<article class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="bg-white rounded-2xl border border-gray-200/60 shadow-sm p-8 sm:p-10">
        <div class="prose max-w-none">
            ...
            <ol>
                <li><strong>Open the <a href="/tools/watermark">Watermark Tool</a>.</strong> Navigate to our free online watermark tool.</li>
            ...
            <ol>
                ...
                <li><strong><a href="/tools/resize">Resize</a></strong> to your target dimensions</li>
                <li><strong><a href="/tools/watermark">Add watermark</a></strong> using our free tool</li>
                <li><strong><a href="/tools/compress">Compress</a></strong> to reduce file size for web use</li>
            </ol>
