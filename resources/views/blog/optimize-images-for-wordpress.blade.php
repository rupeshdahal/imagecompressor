...
<article class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="bg-white rounded-2xl border border-gray-200/60 shadow-sm p-8 sm:p-10">
        <div class="prose max-w-none">
            ...
            <p>Use our free <a href="{{ route('tool.resize') }}">Image Resizer</a> to resize images to the exact dimensions you need.</p>
            ...
            <p>Use our <a href="{{ route('tool.compress') }}">Image Compressor</a> to achieve these targets. Most images can be reduced 60–80% without visible quality loss.</p>
            ...
            <p>Use our <a href="{{ route('tool.convert') }}">Image Converter</a> to convert JPG and PNG images to WebP format before uploading.</p>
