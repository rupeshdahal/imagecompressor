...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="mb-14">
        @include('partials.tools.widget-img2pdf')
    </div>
    ...
    <div class="mb-10">
        ...
        <div class="grid sm:grid-cols-3 gap-4">
            <a href="{{ route('tool.pdf2img') }}" class="bg-white rounded-2xl border border-gray-200/60 p-5 hover:shadow-lg transition-shadow group text-center">
