...
class SeoCheck extends Command
{
    ...
    public function handle(): int
    {
        ...
        $publicPaths = [
            ...
            '/blog/reduce-image-size-for-email',
            '/blog/core-web-vitals-image-optimization',
            '/blog/batch-image-compression-workflow',
            '/blog/best-image-formats-for-social-media',
            '/blog/how-to-add-watermark-to-photos',
            '/blog/optimize-images-for-wordpress',
            '/blog/convert-images-to-pdf-guide',
            '/about',
            '/contact',
            '/sitemap',
            '/privacy-policy',
